...
class forumhistory_module
{
    ...
    {
        global $language, $template, $request, $config, $phpbb_root_path, $phpEx, $cache;

        // Include funções admin para make_forum_select
        require_once($phpbb_root_path . 'includes/functions_admin.' . $phpEx);

        // Carrega o arquivo de linguagem
        $language->add_lang(['common', 'info_acp_forumhistory'], 'mundophpbb/forumhistory');
        ...
        if ($request->is_set_post('submit'))
        {
            ...
            // Nova configuração: formato da data
            $config->set('forumhistory_date_format', $request->variable('forumhistory_date_format', 'default'));
        ...
        $template->assign_vars([
            ...
            // Nova variável para o template
            'FORUMHISTORY_DATE_FORMAT'       => $config['forumhistory_date_format'],
